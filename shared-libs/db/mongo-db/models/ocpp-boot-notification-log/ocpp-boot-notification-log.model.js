...
const OcppBootNotificationLogSchema = new Schema(
  {
...
OcppBootNotificationLogSchema.index(
  { createdAt: 1 },
  { expireAfterSeconds: 7 * 24 * 60 * 60 } // 7 days
);

const OcppBootNotificationLogModel = mongoose.model(
  "OcppBootNotificationLog",
  OcppBootNotificationLogSchema
);
module.exports = { OcppBootNotificationLogModel };
